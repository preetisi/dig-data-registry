<template>
    <v-row v-if="$auth.isAuthenticated" align="center" class="list px-3 mx-auto">
        <v-col cols="12" md="8">
...
<script>
import DatasetRegService from "../services/DatasetRegService";
...
export default {
    ...
    methods: {
        ...
        searchByDatasetName() {
            DatasetRegService.findByUsername(this.username)
                .then(response => {
